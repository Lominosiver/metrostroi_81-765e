...
Entities.gmod_subway_81-760e.Name = 81-760E (Chura head)
Entities.gmod_subway_81-761e.Name = 81-761E (Chura intermediate motor)
Entities.gmod_subway_81-763e.Name = 81-763E (Chura intermediate trailer)
...
Entities.gmod_subway_81-760e.Spawner.VVVFSound.1             = Stock KATP-1 (DTA) from 81-760
...
Entities.gmod_subway_81-760e.Spawner.VVVFSound.8             = KATP-3 Experimental
...
Entities.gmod_subway_81-760e.Buttons.PUR.DoorLeftSet                 = @[Common.720.KDL]
Entities.gmod_subway_81-760e.Buttons.PUR.R_MicroSet                  = @[Common.760.R_Micro]
Entities.gmod_subway_81-760e.Buttons.PUR.HeadlightsSwitch+           = @[Common.ALL.VF] @[Common.ALL.Up]
Entities.gmod_subway_81-760e.Buttons.PUR.HeadlightsSwitch-           = @[Common.ALL.VF] @[Common.ALL.Down]
Entities.gmod_subway_81-760e.Buttons.PUR.DoorCloseToggle             = @[Common.720.DoorClose]
Entities.gmod_subway_81-760e.Buttons.PUR.AttentionMessageSet         = @[Common.720.AttentionMessage]
Entities.gmod_subway_81-760e.Buttons.PUR.AttentionSet                = @[Common.ARS.KB]
Entities.gmod_subway_81-760e.Buttons.PUR.AttentionBrakeSet           = @[Common.ARS.KVT]
Entities.gmod_subway_81-760e.Buttons.PUR.HornBSet                    = @[Common.ALL.Horn]
Entities.gmod_subway_81-760e.Buttons.PUR.DoorRightSet                = @[Common.720.KDP]
Entities.gmod_subway_81-760e.Buttons.PUR.R_Program1Set               = @[Common.720.R_Program1]

Entities.gmod_subway_81-760e.Buttons.PUR2.EmerBrakeAddSet             = @[Common.720.EBrakeAdd]
Entities.gmod_subway_81-760e.Buttons.PUR2.EmerBrakeReleaseSet         = @[Common.720.EBrakeRelease]
Entities.gmod_subway_81-760e.Buttons.PUR2.EmerBrakeToggle             = @[Common.720.EBrakeToggle]
Entities.gmod_subway_81-760e.Buttons.PUR2.EmergencyBrakeToggle        = @[Common.720.EmergencyBrake]
Entities.gmod_subway_81-760e.Buttons.PUR2.R_Program11Set              = @[Common.720.R_Program1]
Entities.gmod_subway_81-760e.Buttons.PUR2.SDkToggle                   = @[Common.760.Cover] @[Common.760.SD]
...
Entities.gmod_subway_81-760e.Buttons.PUU.!DoorsClosed                = @[Common.ALL.LSD]
Entities.gmod_subway_81-760e.Buttons.PUU.R_LineToggle                = @[Common.720.R_Line]
Entities.gmod_subway_81-760e.Buttons.PUU.AccelRateSet                = @[Common.720.AccelRate]
Entities.gmod_subway_81-760e.Buttons.PUU.EnableBVSet                 = @[Common.720.EnableBV]
Entities.gmod_subway_81-760e.Buttons.PUU.DisableBVSet                = @[Common.720.DisableBV]
Entities.gmod_subway_81-760e.Buttons.PUU.RingSet                     = @[Common.720.Ring]
Entities.gmod_subway_81-760e.Buttons.PUU.KAHToggle                   = @[Common.720.KAH]
Entities.gmod_subway_81-760e.Buttons.PUU.ALSToggle                   = @[Common.720.ALS]
Entities.gmod_subway_81-760e.Buttons.PUU.ALSkToggle                  = @[Common.720.ALSK]
Entities.gmod_subway_81-760e.Buttons.PUU.WiperToggle                 = @[Common.720.Wiper]
Entities.gmod_subway_81-760e.Buttons.PUU.WasherSet                   = @[Common.722.GlassWasher]
Entities.gmod_subway_81-760e.Buttons.PUU.GlassHeatingToggle          = @[Common.760.GlassHeating]
Entities.gmod_subway_81-760e.Buttons.PUU.PrToggle                    = @[Common.760.Pr]
Entities.gmod_subway_81-760e.Buttons.PUU.SCToggle                    = @[Common.ALL.Unsused1]
Entities.gmod_subway_81-760e.Buttons.PUU.AutoDriveToggle             = @[Common.ALL.Unsused1]
Entities.gmod_subway_81-760e.Buttons.PUU.OtklRToggle                 = @[Common.760.OtklR]
Entities.gmod_subway_81-760e.Buttons.PUU.R_ToBackSet                 = @[Common.760.R_ToBack]
Entities.gmod_subway_81-760e.Buttons.PUU.R_ChangeRouteToggle         = @[Common.760.R_ChangeRoute]

Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz1Set        = @[Common.Vityaz.1]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz2Set        = @[Common.Vityaz.2]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz3Set        = @[Common.Vityaz.3]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz4Set        = @[Common.Vityaz.4]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz5Set        = @[Common.Vityaz.5]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz6Set        = @[Common.Vityaz.6]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz7Set        = @[Common.Vityaz.7]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz8Set        = @[Common.Vityaz.8]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz9Set        = @[Common.Vityaz.9]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.Vityaz0Set        = @[Common.Vityaz.0]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.VityazF5Set       = @[Common.760.VityazF5]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.VityazF6Set       = @[Common.760.VityazF6]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.VityazF7Set       = @[Common.760.VityazF7]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.VityazF8Set       = @[Common.760.VityazF8]
Entities.gmod_subway_81-760e.Buttons.VityazButtons.VityazF9Set       = @[Common.760.VityazF9]
...
Entities.gmod_subway_81-761e.Buttons.couch_capL.CouchCapL          = @[Common.760.Cabinet]
Entities.gmod_subway_81-761e.Buttons.couch_capL_o.CouchCapL        = @[Common.760.Cabinet]
Entities.gmod_subway_81-761e.Buttons.couch_capR.CouchCapR          = @[Common.760.Cabinet]
Entities.gmod_subway_81-761e.Buttons.couch_capR_o.CouchCapR        = @[Common.760.Cabinet]
...
Entities.gmod_subway_81-763e.Buttons.couch_capL.CouchCapL          = @[Common.760.Cabinet]
Entities.gmod_subway_81-763e.Buttons.couch_capL_o.CouchCapL        = @[Common.760.Cabinet]
Entities.gmod_subway_81-763e.Buttons.couch_capR.CouchCapR          = @[Common.760.Cabinet]
Entities.gmod_subway_81-763e.Buttons.couch_capR_o.CouchCapR        = @[Common.760.Cabinet]
]]
