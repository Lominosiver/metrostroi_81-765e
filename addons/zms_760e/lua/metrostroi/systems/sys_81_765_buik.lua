...
if SERVER then
    ...
    local colorDarkerWhite = Color(204, 204, 204)
    local colorDisabled = Color(27, 27, 27)
    local colorBackground = Color(9, 14, 27)
    local colorBackgroundSpeedometer = Color(9, 14, 27)
    local colorInactive = Color(27, 51, 122)
    local colorActive = Color(232, 238, 255)
    local colorSelected = Color(91, 177, 218)
    ...
    local colorSelectedLineActive = Color(12, 228, 255)
    local colorSelectedLineInactive = Color(7, 67, 255)
    local colorLineTextActive = Color(255, 255, 255)
    local colorLineTextInactive = Color(91, 177, 218)
    local logo = Material("zxc765/PIVO_logo_lt.png", "smooth")
    logo:SetInt("$flags", bit.bor(logo:GetInt("$flags"), 32768))
