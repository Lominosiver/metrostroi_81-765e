...
function TRAIN_SYSTEM:Think(dT)
    ...
    self.ATS1 = not UOS and Train.SF4.Value > 0.5 and (Train.BARSBlock.Value == 0 or Train.BARSBlock.Value == 1)
    self.ATS2 = not UOS and Train.SF5.Value > 0.5 and (Train.BARSBlock.Value == 0 or Train.BARSBlock.Value == 2)
