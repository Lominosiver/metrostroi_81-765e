...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_761E_BUV")
...
function TRAIN_SYSTEM:Think(dT)
    ...
    if self.State and Train.SF46.Value > 0.5 then --and Train.Electric.Power == 1 
    ...
    self.PSN = not self:Get("PVU8") and Train.Electric.Battery80V > 67 and (self.PSNSignal or Train.SA4 and Train.SA4.Value > 0.5) and Train.Battery.Value * Train.SF45.Value * Train.Electric.KM2 or 0
